...
* The original package name 'ir.darkdeveloper.websocket-sample' is invalid and this project uses 'ir.darkdeveloper.websocketsample' instead.
...
```
$ docker run --rm -p 8080:8080 websocket-sample:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/websocket-sample
```
