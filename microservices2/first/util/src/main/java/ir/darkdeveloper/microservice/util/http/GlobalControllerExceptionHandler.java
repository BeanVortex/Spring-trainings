package ir.darkdeveloper.microservice.util.http;
...
class GlobalControllerExceptionHandler {
    ...
    public @ResponseBody
    HttpErrorInfo handleNotFoundExceptions(ServerHttpRequest request,
    ...
    public @ResponseBody
    HttpErrorInfo handleInvalidInputException(ServerHttpRequest request,
